...
class SectionResponse(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'Section': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['Section', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        data: typing.Union['Section', schemas.Unset] = schemas.unset,
