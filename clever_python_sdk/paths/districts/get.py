...
from clever_python_sdk.model.districts_response import DistrictsResponse as DistrictsResponseSchema

from clever_python_sdk.type.districts_response import DistrictsResponse

from ...api_client import Dictionary
from clever_python_sdk.pydantic.districts_response import DistrictsResponse as DistrictsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DistrictsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DistrictsResponse
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DistrictsResponsePydantic:
        raw_response = await self.raw.aget_list(
            count=count,
            **kwargs,
        )
        if validate:
            return DistrictsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DistrictsResponsePydantic, raw_response.body)
