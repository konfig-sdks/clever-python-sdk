...
class BaseApi(api_client.Api):
    ...
    def _get_teachers_for_user_mapped_args(
        self,
        id: str,
    ...
    async def _aget_teachers_for_user_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{id}/myteachers',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_teachers_for_user_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetTeachersForUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_teachers_for_user(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        starting_after: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_teachers_for_user_mapped_args(
            id=id,
            limit=limit,
            starting_after=starting_after,
            ending_before=ending_before,
        )
        return await self._aget_teachers_for_user_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_teachers_for_user(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        starting_after: typing.Optional[str] = None,
        ...
        return self._get_teachers_for_user_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTeachersForUser(BaseApi):
    ...
    async def aget_teachers_for_user(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_teachers_for_user(
            id=id,
            limit=limit,
            starting_after=starting_after,
            ending_before=ending_before,
    ...
    def get_teachers_for_user(
        ...
        raw_response = self.raw.get_teachers_for_user(
            id=id,
            limit=limit,
            starting_after=starting_after,
            ending_before=ending_before,
